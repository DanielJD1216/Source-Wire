...
| `npm run alpha1:test` | Focused Alpha unit coverage, including Story 6.1 config, Story 6.2 memory-only authority, Story 6.3 provider checks, locked Story 6.4 fault injection, and Story 6.5 command envelopes |
