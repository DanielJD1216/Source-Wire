...
printList([
  ...
  "docs/hosted-runtime-prd-execution-packet.md records the exact future hosted runtime PRD scope, pre-execution checks, verification path, and stop conditions while runtime implementation remains blocked",
  ...
  "docs/contribution-terms-prd-execution-packet.md records the exact future contribution terms PRD scope, pre-execution checks, verification path, and stop conditions while code contribution acceptance remains blocked",
  ...
  "docs/branch-governance-execution-packet.md records the exact future minimal branch protection settings, pre-execution checks, verification, and rollback path while live GitHub settings remain unchanged",
  "docs/branch-governance-implementation-dry-run.md records the owner-side dry-run payload and exact required check context before future branch protection changes",
  "docs/branch-governance-apply.md records the guarded owner-side branch protection apply command, exact approval requirement, write confirmation, and blocked default mode",
  ...
  "npm run repository:branch-governance-execution-packet verifies the exact future minimal branch protection execution packet without changing GitHub settings",
  "npm run repository:branch-governance-dry-run verifies the future branch-protection payload and live required check context without changing GitHub settings",
