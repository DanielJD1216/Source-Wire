...
| Owner-hosted versus managed-hosted boundary | [Hosted Runtime PRD](hosted-runtime-prd.md), [Public Runtime Decision](public-runtime-decision.md), [Runtime Boundary](../concepts/runtime-boundary.md) | managed-hosted service, Source-Wire-hosted user memory, deployment |
...
| Deployment boundary | [Hosted Runtime PRD](hosted-runtime-prd.md), [Hosted Runtime PRD Slice Map](hosted-runtime-issue-slices.md), [Runtime Boundary](../concepts/runtime-boundary.md) | deployment config, cloud resources, production runtime use |
...
| No-private-data requirements | [Hosted Runtime PRD](hosted-runtime-prd.md), [Legal Review Question Packet](legal-review-question-packet.md), [Public Status](../status/public-status.md) | private owner context, real user data, client data, secrets, local paths, production exports |
