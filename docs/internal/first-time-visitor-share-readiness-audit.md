...
| Evidence | Where |
| --- | --- |
| Current public boundary | [Public Status](../status/public-status.md) |
| Public share copy | [World Share Kit](world-share-kit.md) |
| GitHub metadata and CI visibility | [Repository Metadata](../reference/repository-metadata.md) |
| Review path | [Technical Reviewer Guide](../guides/technical-reviewer-guide.md) |
| Feedback path | [Reviewer Feedback Guide](../guides/reviewer-feedback-guide.md) |
| Local readiness marker map | [Publish Readiness](../guides/publish-readiness.md) |
| CI marker map | [CI Checks](../reference/ci-checks.md) |
