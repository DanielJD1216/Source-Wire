...
printList([
  ...
  "docs/release-patch-approval-request.md records the future patch release approval path for the immutable npm 0.1.0 SOURCE_WIRE_PACKAGE_VERSION mismatch while keeping release mutation blocked",
  "docs/release-patch-execution-preflight.md records the read-only patch release execution preflight, exact approval requirement, and blocked mutation boundary",
  "docs/release-patch-candidate-rehearsal.md records the temp-directory 0.1.1 patch rehearsal without mutating real package files",
  ...
  "docs/runtime-first-implementation-recommendation.md records why issue #259 threat-model implementation is the recommended first approval gate",
  ...
  "docs/mcp-adapter-contract-implementation-proof.md records the synthetic MCP adapter contract implementation proof while MCP server runtime remains blocked",
  "docs/mcp-adapter-contract-smoke.md records the synthetic MCP adapter contract smoke command, expected markers, and blocked side effects",
  ...
  "docs/api-contract-implementation-slices.md records the future request envelope, endpoint group, policy matrix, smoke, docs, and readiness slices",
  "docs/mcp-contract-implementation-packet.md records the synthetic MCP adapter contract implementation approval path and completed proof while MCP server runtime remains blocked",
  "docs/mcp-contract-implementation-slices.md records the completed tool declaration, input validation, MCP-to-API envelope, policy matrix, smoke, docs, and readiness slices",
  "docs/database-posture-implementation-packet.md records the implemented synthetic database posture package while migrations and real database connections remain blocked",
  "docs/database-posture-implementation-proof.md records the synthetic database posture package proof while real database runtime remains blocked",
  "docs/database-posture-implementation-slices.md records the completed data-class, lifecycle, namespace, deletion, retention, backup, restore, smoke, and docs slices",
  "docs/database-posture-smoke.md records the synthetic database posture smoke command, expected markers, and blocked side effects",
  "docs/public-safe-fixture-implementation-packet.md records the implemented synthetic hosted-runtime fixture package while real services and real data remain blocked",
  "docs/public-safe-fixture-implementation-proof.md records the synthetic hosted-runtime fixture package proof while hosted runtime remains blocked",
  "docs/public-safe-fixture-implementation-slices.md records the completed fixture contract, fixture matrix, smoke, docs, and readiness slices",
  "docs/public-safe-fixture-smoke.md records the synthetic hosted-runtime fixture smoke command, expected markers, and blocked side effects",
  "docs/deployment-boundary-implementation-packet.md records the implemented synthetic deployment-boundary package while deployment config and hosted services remain blocked",
  "docs/deployment-boundary-implementation-proof.md records the synthetic deployment-boundary package proof while hosted runtime implementation remains blocked",
  "docs/deployment-boundary-implementation-slices.md records the completed local, owner-hosted, managed-hosted, stop-condition, rollback, smoke, docs, and readiness slices",
  "docs/deployment-boundary-smoke.md records the synthetic deployment-boundary smoke command, expected markers, and blocked side effects",
