...
Use [Publish Readiness](../guides/publish-readiness.md) for the local success marker map. Use [CI Checks](../reference/ci-checks.md) for the matching GitHub Actions Package Checks marker map.
