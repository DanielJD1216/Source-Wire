...
- npm publishing becomes possible outside the approved release execution path,
- GitHub release publishing is added outside the approved release execution path,
