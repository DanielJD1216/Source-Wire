...
Status: implemented in `src/contracts/owner-hosted-setup.ts`, with proof in `docs/internal/owner-hosted-setup-slice-1-proof.md`.

File: `docs/internal/issues/owner-hosted-setup/01-setup-contract-owner-brings-checklist.md`
...
Status: implemented in `examples/fixtures/owner-hosted-setup/setup-readiness-fixture-matrix.json`, with proof in `docs/internal/owner-hosted-setup-slice-2-proof.md`.

File: `docs/internal/issues/owner-hosted-setup/02-synthetic-setup-readiness-fixture-matrix.md`
...
Status: implemented in `examples/owner-hosted-setup/setup-readiness-smoke.mjs`, with proof in `docs/internal/owner-hosted-setup-slice-3-proof.md`.

File: `docs/internal/issues/owner-hosted-setup/03-setup-readiness-smoke.md`
...
Status: implemented in `examples/owner-hosted-setup/source-update-safety-smoke.mjs`, with proof in `docs/internal/owner-hosted-setup-slice-4-proof.md`.

File: `docs/internal/issues/owner-hosted-setup/04-source-update-safety-smoke.md`
...
Status: implemented in `docs/internal/owner-hosted-setup-claim-boundary.md`, with proof in `docs/internal/owner-hosted-setup-slice-5-proof.md`.

File: `docs/internal/issues/owner-hosted-setup/05-setup-docs-claim-boundary.md`
...
Status: implemented in `docs/internal/owner-hosted-setup-final-proof.md`, `docs/internal/owner-hosted-setup-docs-audit.md`, and `docs/internal/owner-hosted-setup-go-no-go-gate.md`.

File: `docs/internal/issues/owner-hosted-setup/06-proof-docs-go-no-go-gate.md`
