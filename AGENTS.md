...
- Story 6.1 adds config creation and offline validation only. It does not start API, MCP, PostgreSQL, or provider processes, and it does not broaden any Alpha authority.
...
For the private Story 6.1 CLI tracer:
