...
printList([
  ...
  "docs/deployment-boundary-implementation-packet.md records the next synthetic deployment-boundary implementation approval path while deployment config and hosted services remain blocked",
  "docs/deployment-boundary-implementation-slices.md records the future local, owner-hosted, managed-hosted, stop-condition, rollback, smoke, docs, and readiness slices",
