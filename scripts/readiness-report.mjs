...
printRows([
  ...
  ["Runtime boundary", "synthetic in-memory boundary plus synthetic API/MCP skeleton, threat-boundary package, API policy contract package, MCP adapter contract package, and database posture package only, no backend runtime included"]
]);
...
printList([
  ...
  "docs/public-safe-fixture-implementation-packet.md records the next synthetic hosted-runtime fixture implementation approval path while real services and real data remain blocked",
  "docs/public-safe-fixture-implementation-slices.md records the future fixture contract, fixture matrix, smoke, docs, and readiness slices",
