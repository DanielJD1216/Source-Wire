...
- The malformed external license links in `docs/internal/memory-engine-baseline-license-path-decision-packet.md` were corrected from inline-code URLs to Markdown links.
...
Supported cause: `docs/internal/memory-engine-baseline-license-path-decision-packet.md` used inline-code URL formatting, and the external-link checker included the closing backtick in the fetched URL.
