...
printList([
  ...
  "12. Run npm run runtime:prd-refresh-proof to verify the refreshed PRD and wrapper-runtime gate.",
  "13. Run npm run runtime:prd-refresh-approval-status to verify the exact approval remains recorded.",
...
printList([
  ...
  "Use npm run runtime:prd-refresh-proof before any hosted runtime implementation planning.",
