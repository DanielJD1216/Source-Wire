...
| --- | --- | --- |
| Diagram source exists | `docs/diagrams/memory-engine-baseline-audit/self-hosted-runtime-boundary.puml` | Boundary diagram is source-controlled. |
| Diagram render proof exists | `docs/diagrams/memory-engine-baseline-audit/render-proof.json` | Diagram was rendered from source. |
| Diagram outputs exist | `.svg` and `.png` files | Reviewers can inspect the diagram without rendering locally. |
| Visual quality proof exists | `docs/diagrams/memory-engine-baseline-audit/quality-review.json` | Diagram was reviewed for clarity and privacy. |
