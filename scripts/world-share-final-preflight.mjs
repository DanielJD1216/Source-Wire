...
const checks = [
  ...
  ["runtime:child-issue-publication-preflight", "hosted runtime child issue publication preflight"],
...
console.log("ok hosted runtime child issue publication preflight current");
