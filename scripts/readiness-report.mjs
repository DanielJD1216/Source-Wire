...
printList([
  ...
  "npm run release:decision-preflight verifies world-share, release-candidate, artifact, approval-request, and launch-decision evidence before owner release approval",
  ...
  "npm run world:share-preflight verifies public external links, live world-share status, launch decision blockers, and owner-decision issue status before broad public sharing",
