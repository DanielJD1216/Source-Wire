...
- [Alpha 1 Story 6.9: Local Runtime Security Alpha](getting-started/alpha1-story6-local-runtime-package-candidate.md)
- [Local Runtime 0.1.0-alpha.1 npm Release](status/local-runtime-0.1.0-alpha.1-release.md)
- [Local Runtime 0.1.0-alpha.2 npm Release](status/local-runtime-0.1.0-alpha.2-release.md)

The Alpha stories use generated disposable PostgreSQL state. Story 6.8
published `0.1.0-alpha.1`, which is now deprecated. Story 6.9 published
`0.1.0-alpha.2` under the npm `alpha` tag with the security fixes. npm availability does not
