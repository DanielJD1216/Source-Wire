...
printList([
  ...
  "docs/release-auth-handoff.md records the owner-side npm login handoff without approving release execution",
  "docs/release-auth-preflight.md records the owner-side npm and GitHub authentication preflight required before release execution",
  "npm run release:decision-preflight verifies world-share, owner open-issue boundary, release-candidate, artifact, approval-request, and launch-decision evidence before release execution",
  "docs/release-execution-preflight.md records the read-only owner-side release execution preflight that gathers approval, package readiness, artifact, live tag, live registry, and live world-share evidence while execution remains blocked",
  "docs/release-candidate-readiness.md records the release-candidate preflight while release execution remains unperformed",
