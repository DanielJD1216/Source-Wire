...
For the full local readiness marker map, read [Publish Readiness](../guides/publish-readiness.md). For the GitHub Actions Package Checks marker map, read [CI Checks](../reference/ci-checks.md).
