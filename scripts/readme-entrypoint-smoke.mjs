...
for (const requiredText of [
  ...
  "Story 6.8 prepares the public npm Alpha release candidate `@source-wire/local-runtime@0.1.0-alpha.1` and the `source-wire-local` binary for macOS and Linux local evaluation with synthetic or disposable data.",
  "Registry publication is approved but still pending the exact-revision release gate.",
  "Nothing is deployed, hosted, tagged, or released from that candidate.",
