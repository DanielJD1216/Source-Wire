...
const approvalTargets = [
  ...
  },
  {
    ...
    approvalName: "patch release implementation",
  ...
  },
  {
    ...
    approvalName: "runtime skeleton implementation",
    allowClosedIssue: true,
    requiresApprovalRecordSection: true,
    exactApprovalText:
  ...
  },
  {
    ...
    approvalName: "owner-hosted runtime implementation",
    allowClosedIssue: true,
    requiresApprovalRecordSection: true,
    exactApprovalText:
  ...
  },
  {
    ...
    approvalName: "threat model implementation",
    allowClosedIssue: false,
    requiresApprovalRecordSection: true,
    exactApprovalText:
  ...
  },
  {
    ...
    approvalName: "API contract implementation",
    allowClosedIssue: false,
    requiresApprovalRecordSection: true,
    exactApprovalText:
  ...
  },
  {
    ...
    approvalName: "database posture implementation",
    allowClosedIssue: false,
    requiresApprovalRecordSection: true,
    exactApprovalText:
  ...
  },
  {
    ...
    approvalName: "public-safe fixture implementation",
    allowClosedIssue: false,
    requiresApprovalRecordSection: true,
    exactApprovalText:
  ...
  },
  {
    ...
    approvalName: "deployment boundary implementation",
    allowClosedIssue: false,
    requiresApprovalRecordSection: true,
    exactApprovalText:
...
function printUsage() {
  ...
  console.log("  npm run owner:record-approval -- --target patch-release-implementation");
