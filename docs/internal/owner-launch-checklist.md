...
| --- | --- | --- |
| Technical review sharing | Ready | Use [Share For Technical Review](../guides/share-for-review.md). |
...
| Minimal branch protection | Implemented | Use [Branch Governance Apply Guard](branch-governance-apply.md) and [Repository Metadata](../reference/repository-metadata.md) for live proof. |
